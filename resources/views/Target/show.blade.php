    ...
    <div class="col-lg-12 mt-20">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Target Details</h5>
            </div>
            <div class="card-body">
                <form class="row gy-3 needs-validation" novalidate>
                    <div class="col-md-6">
                        ...
                        <div class="icon-field">
                            ...
                            <input type="text" class="form-control" value="{{ $target->getFullUrlAttribute() }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="icon-field">
                            ...
                            <input type="text" class="form-control" value="{{ $target->domain }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="icon-field">
                            ...
                            <input type="text" class="form-control" value="{{ $target->ip_address }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="icon-field">
                            ...
                            <input type="text" class="form-control" value="{{ $target->server_type ?? 'N/A' }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label">CMS Information</label>
                        <div class="icon-field">
                            @if($target->technology && $target->technology->has_cms)
                                <p><strong>Name:</strong> {{ $target->technology->cms_name }}</p>
                                <p><strong>Version:</strong> {{ $target->technology->cms_version ?? 'Unknown' }}</p>
                            @else
                                <p>No CMS detected</p>
                            @endif
                        </div>
                    </div>
                    @if($target->technology && $target->technology->technologies)
                    <div class="col-md-12">
                        <label class="form-label"><strong>Technologies:</strong></label>
                        <ul>
                            @foreach($target->technology->technologies as $tech)
                                <li>{{ $tech }}</li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="col-md-12 mt-3">
                        <a href="{{ route('targets.edit', $target->id) }}" class="btn btn-primary">Edit</a>
                        <a href="{{ route('targets') }}" class="btn btn-secondary">Back</a>
                    </div>
                </form>
            </div>
        </div>
